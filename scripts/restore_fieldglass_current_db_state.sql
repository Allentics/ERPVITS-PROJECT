...
VALUES (
    ...
    '[
        {
            ...
            "title": "Learn SAP Fieldglass from Certified Experts – <span class=\"text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-red-600\">100% Hands-On, Job-Oriented Training</span>",
    ...
    '/syllabus/ERPVITS Syllabus - Course Contents Pdf/SAP Functional/sap-fieldglass.pdf',
    NOW()
)
