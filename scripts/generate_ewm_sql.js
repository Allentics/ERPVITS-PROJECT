...
const ewmContent = {
    ...
    metaKeywords: 'sap ewm, sap ewm certification, sap ewm course, sap ewm online training, sap ewm training, sap warehouse management, sap warehouse management course, sap warehouse management system, sap warehouse management training, warehouse courses, warehouse management certification, warehouse management course, warehouse management course online, warehouse management training',
    ...
    sections: [
        ...
        },
        {
            ...
            "title": "Why Professionals Choose ERPVITS for <span class=\"text-orange-600\">SAP EWM Online Training</span>",
        ...
        // Second 'Why Choose Us' section removed as per user request
        {
            "type": "whats_included",
        ...
        },
        {
            ...
            "title": "What You'll Master in This SAP EWM Online Course – <span class=\"text-orange-600\">Core Competencies</span>",
        ...
        },
        {
            ...
            "customData": {
                ...
                "hiringTrends": {
                    ...
                    "stats": [
                        { "value": "500+", "label": "Alumni Worldwide", "color": "blue" },
                        { "value": "96%", "label": "Placement Rate", "color": "green" },
                        { "value": "2-3 Months", "label": "Average Job Placement", "color": "orange" }
                    ]
                }
            }
        },
        ...
        },
        {
            ...
            "items": [
                ...
                },
                {
                    ...
                    "points": [
                        "Months 1-3: Learn client operations, understand current processes",
                        "Months 4-6: Lead small configuration tasks, support warehouse planning",
                        "Months 7-12: Lead warehouse management components, drive process improvements"
                    ],
                    "icon": "Briefcase",
                    "color": "slate"
                },
                {
                    ...
                    "points": [
                        ...
                        "Explore specializations (automation, analytics)"
                    ],
                    "icon": "Award",
                    "color": "orange"
                }
            ...
            "stats": [
                { "value": "2-3 Months", "label": "Average Time to First Role", "icon": "Clock" },
                { "value": "100%", "label": "Career Support Provided", "icon": "Briefcase" },
                { "value": "6 Months", "label": "Post-Training Support", "icon": "Headphones" },
                { "value": "Lifetime", "label": "Alumni Network Access", "icon": "Users" }
            ]
        },
        {
...
const sql = `
-- Ensure meta_keywords column exists
ALTER TABLE courses ADD COLUMN IF NOT EXISTS meta_keywords TEXT;

-- Update SAP EWM Course Content
UPDATE courses
SET
    title = '${escapeSql(ewmContent.title)}',
    meta_title = '${escapeSql(ewmContent.metaTitle)}',
    meta_description = '${escapeSql(ewmContent.metaDescription)}',
    meta_keywords = '${escapeSql(ewmContent.metaKeywords)}',
    hero_heading = '${escapeSql(ewmContent.heroHeading)}',
    hero_subheading = '${escapeSql(ewmContent.heroSubheading)}',
    description = '${escapeSql(ewmContent.description)}',
    features = '${JSON.stringify(ewmContent.features)}'::jsonb,
    sections = '${JSON.stringify(ewmContent.sections).replace(/'/g, "''")}'::jsonb,
    updated_at = NOW()
WHERE id = '${ewmContent.id}';
`;

fs.writeFileSync('scripts/update_ewm_complete.sql', sql.trim());
console.log('SQL script generated: scripts/update_ewm_complete.sql');
