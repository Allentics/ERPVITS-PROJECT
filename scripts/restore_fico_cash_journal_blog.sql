...
SET content = '<article class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 font-sans text-gray-800 leading-relaxed">
            ...
            <section class="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-100">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={code} class="bg-white p-3 rounded shadow-sm text-center">
                            <span class="block font-mono font-bold text-orange-600 text-lg">{code}</span>
                            <span class="text-xs text-gray-500 uppercase">{desc}</span>
                        </div>
                    ))}
                </div>
            </section>
