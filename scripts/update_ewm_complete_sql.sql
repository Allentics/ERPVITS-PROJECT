...
-- Includes Hero, Features, Curriculum, FAQs, and Post-Training Roadmap
...
SET 
  ...
  hero_subheading = 'Become an expert in SAP Extended Warehouse Management (EWM) on S/4HANA. Master inbound/outbound processing, RF framework, and complex warehouse logistics with 100% hands-on training.',
  description = 'For supply chain professionals and SAP consultants, mastering Extended Warehouse Management is crucial for modern logistics. The ERPVITS SAP EWM Training Program provides extensive, hands-on learning on the S/4HANA Embedded EWM platform. From standard inbound/outbound flows to complex cross-docking, yard management, and RF mobile data entry, we cover it all. Our curriculum is designed to help you clear the C_S4EWM certification and excel in real-world implementation projects.',
  
  -- Top Level Features Array
  features = '["S/4HANA Embedded EWM", "RF & Mobile Framework", "Real-Time Scenarios", "Certification Ready", "Placement Support", "40+ Hours Live"]'::jsonb,
