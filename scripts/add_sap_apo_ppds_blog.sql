...
VALUES ('what-is-ppds-in-sap-apo-features-benefits-real-time-business-scenarios', 'What is PPDS in SAP APO? Features, Benefits & Real-Time Business Scenarios', 'A comprehensive guide to SAP APO PPDS bridging the gaps between high-level demand planning and shop floor execution, with real-time scenarios.', '<div class="prose prose-lg prose-slate max-w-none 
