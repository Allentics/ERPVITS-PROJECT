...
VALUES ('sap-sd-shipping-point-determination', 'End-to-End SAP SD Shipping Point Determination Process', 'Master SAP SD Shipping Point Determination, Route Determination, and Storage Location Determination. Complete guide to configuration, optimization, and best practices for logistics execution in SAP S/4HANA.', '<div class="prose prose-lg prose-slate max-w-none 
            ...
            <h2 class="text-2xl font-bold mt-8 mb-4">What is SAP SD Determination?</h2>
            <p>
            ...
            <h2 class="text-2xl font-bold mt-8 mb-4">Key Components of SAP SD Determination Process</h2>
            ...
            <h2 class="text-2xl font-bold mt-8 mb-4">SAP SD Shipping Point Determination</h2>
            <h3 class="text-xl font-bold mt-6 mb-3">Overview of Shipping Point Determination</h3>
            <p>
            ...
            <h3 class="text-xl font-bold mt-6 mb-3">Shipping Point Table in SAP</h3>
            <p>
            ...
            <div class="mt-6 mb-6 italic bg-gray-50 p-6 border-l-4 border-orange-500 rounded-r-xl shadow-sm">
                <div class="font-bold text-gray-900 not-italic mb-2">Key Table Details</div>
                <ul class="list-disc pl-6 space-y-1 not-italic text-gray-700">
            ...
            <h3 class="text-xl font-bold mt-6 mb-3">Configuration Steps for Shipping Point Determination</h3>
            <div class="space-y-6 mt-4">
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 1: Specify Shipping Points</h4>
                    <p class="text-slate-600">Go to SPRO → Logistics Execution → Shipping → Basic Shipping Functions → Shipping Point and Goods Receiving Point Determination → Define Shipping Points. Specify shipping points and include information such as full addresses, operational time schedules, and organizational details.</p>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 2: Define Loading Groups</h4>
                    <p class="text-slate-600">Set the loading groups in SPRO → Logistics Execution → Shipping → Basic Shipping Functions → Shipping Point Determination → Define Loading Group. Then, in the Sales: General/Plant data view, subordinate the loading groups to the material masters.</p>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 3: Specify the Shipping Conditions</h4>
                    <p class="text-slate-600">Configure the shipping conditions in SPRO → Logistics Execution → Shipping → Basic Shipping Functions → Shipping Point Determination → Define Shipping Conditions. The shipping conditions are assigned to customer masters or sales order type masters.</p>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 4: Assign Shipping Points</h4>
                    <p class="text-slate-600">Use transaction OVXD to create the determination rule. Specify the shipping conditions, the loading group, and plant to obtain a particular shipping point. This rule becomes part of the configuration table, which the automatic order processing determination relies on.</p>
                </div>
            </div>

            <h2 class="text-2xl font-bold mt-8 mb-4">Route Determination in SAP SD</h2>
            <h3 class="text-xl font-bold mt-6 mb-3">Understanding SAP SD Route Determination</h3>
            <p>
            ...
            <h3 class="text-xl font-bold mt-6 mb-3">Key Elements of SAP SD Route Determination</h3>
            <ul class="list-disc pl-6 space-y-2">
            ...
            <h3 class="text-xl font-bold mt-6 mb-3">Configuration Steps for Route Determination</h3>
            <div class="space-y-6 mt-4">
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 1: Setting Up Routes</h4>
                    <p class="text-slate-600">Use OVT2 or SPRO path to define routes. Include details, distance, and transportation planning info.</p>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 2: Setting Up Transportation Zones</h4>
                    <p class="text-slate-600">Go to SPRO → Logistics Execution → Shipping → Basic Shipping Functions → Routes → Route Determination → Define Transportation Zones.</p>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 3: Setting Up Departure Zones</h4>
                    <p class="text-slate-600">Use OVT1 to set up the departure zones and link them to shipping points.</p>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 4: Setting Up Route Determination</h4>
                    <p class="text-slate-600">In SPRO, define route determination by assigning combinations of country, departure zone, transportation zone, and shipping condition.</p>
                </div>
            </div>

            <h2 class="text-2xl font-bold mt-8 mb-4">SAP Storage Location Determination</h2>
            <h3 class="text-xl font-bold mt-6 mb-3">Overview of Storage Location Determination</h3>
            <p>
            ...
            <h3 class="text-xl font-bold mt-6 mb-3">Storage Location Determination Methods</h3>
            <ul class="list-disc pl-6 space-y-2">
            ...
            <h3 class="text-xl font-bold mt-6 mb-3">Configuration Steps</h3>
            <div class="space-y-6 mt-4">
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 1: Set the Storage Locations</h4>
                    <p class="text-slate-600">In transaction OX09 or SPRO path, create storage locations for all plants.</p>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 2: Assignment to Material Masters</h4>
                    <p class="text-slate-600">In transaction MM02, set the default storage locations in the Plant Data/Storage 1 view.</p>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 3: Setting Up Determination Rules</h4>
                    <p class="text-slate-600">Define rules for each combination of the shipping point, plant, storage condition, and loading group.</p>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-slate-900 mb-2">Step 4: Establish Storage Conditions</h4>
                    <p class="text-slate-600">Define unique storage requirements like temperature or hazardous materials.</p>
                </div>
            </div>

            <h2 class="text-2xl font-bold mt-8 mb-4">Integration and Best Practices</h2>
            <h3 class="text-xl font-bold mt-6 mb-3">Integration Points in the SD Process</h3>
            <ul class="list-disc pl-6 space-y-2">
            ...
            <h3 class="text-xl font-bold mt-6 mb-3">Best Practices for SAP SD Determination</h3>
            <ul class="list-disc pl-6 space-y-2">
            ...
            <h2 class="text-2xl font-bold mt-8 mb-4">Troubleshooting Common Determination Issues</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
                <div class="bg-red-50 p-6 rounded-xl border border-red-100">
                    <h4 class="font-bold text-red-900 mb-2">Shipping Point Not Determined</h4>
                ...
                <div class="bg-orange-50 p-6 rounded-xl border border-orange-100">
                    <h4 class="font-bold text-orange-900 mb-2">Route Determination Failures</h4>
            ...
            <h2 class="text-2xl font-bold mt-8 mb-4">Advanced Determination Techniques</h2>
            ...
            <div class="mt-12 mb-8">
                ...
                <p class="text-slate-600 mb-6">Stay updated with the latest insights on SAP SD best practices and configuration tips:</p>
