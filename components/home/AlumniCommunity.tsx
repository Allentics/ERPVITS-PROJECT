            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 max-w-5xl mx-auto">
                    {content.stats?.map((stat: any, index: number) => {
                        ...
                        return (
                            <div key={index} className="bg-white rounded-2xl p-8 text-center shadow-xl border-t-4 border-orange-400">
                ...
                <div className="text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6 mb-12">
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-3 px-8 py-3 bg-[#0077B5] hover:bg-[#006396] text-white font-bold rounded-xl shadow-lg cursor-pointer border border-white/10"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center justify-center gap-3 px-8 py-3 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold rounded-xl shadow-lg cursor-pointer border border-white/10"
                        >
