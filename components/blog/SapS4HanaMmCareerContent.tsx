...
export default function SapS4HanaMmCareerContent() {
    return (
        <div className="prose prose-lg prose-slate max-w-none 
            ...
            <BlogCallout title="Key Reasons for High Demand">
                <ul className="mb-0">
            ...
            <div className="not-prose overflow-x-auto my-6">
                <table className="min-w-full border border-gray-200 rounded-lg overflow-hidden text-sm">
                    <thead className="bg-orange-50 font-bold">
                        <tr>
                            <th className="border-b border-gray-200 px-6 py-3 text-left text-gray-900">Experience Level</th>
                            <th className="border-b border-gray-200 px-6 py-3 text-left text-gray-900">Salary Range (INR)</th>
                        </tr>
                    </thead>
                    <tbody className="bg-white">
                        <tr><td className="border-b border-gray-100 px-6 py-3 font-medium text-orange-600">Fresher</td><td className="border-b border-gray-100 px-6 py-3 text-gray-600">₹4 – 7 LPA</td></tr>
                        <tr className="bg-gray-50"><td className="border-b border-gray-100 px-6 py-3 font-medium text-orange-600">3–5 Years Experience</td><td className="border-b border-gray-100 px-6 py-3 text-gray-600">₹8 – 15 LPA</td></tr>
                        <tr><td className="border-b border-gray-100 px-6 py-3 font-medium text-orange-600">Senior Consultant / Lead</td><td className="border-b border-gray-100 px-6 py-3 text-gray-600">₹18 – 30+ LPA</td></tr>
                    </tbody>
                </table>
            </div>
            <p className="text-sm text-slate-500 mt-2">Salary depends on project exposure, certification, and S/4HANA implementation experience.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
                <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                    <h3 className="!mt-0 text-lg font-bold">Top Hiring Countries</h3>
                    <ul className="mb-0">
                        <li>Germany</li>
                        <li>USA</li>
                        <li>Canada</li>
                ...
                <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                    <h3 className="!mt-0 text-lg font-bold">International Job Roles</h3>
                    <ul className="mb-0">
            ...
            <BlogCallout title="Enroll for SAP S/4HANA MM Training">
                ...
                <p className="mb-0">Our expert-led SAP online training includes live sessions, real-time project scenarios, server access, and placement assistance to help you crack interviews in India and abroad.</p>
            </BlogCallout>
