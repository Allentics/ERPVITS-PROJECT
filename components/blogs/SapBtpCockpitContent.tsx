        ...
        <div className="blog-content prose prose-lg max-w-none">
            ...
            <div className="bg-slate-100 rounded-xl p-6 mt-8">
                ...
                <p className="text-sm text-slate-600 mt-4">
                    Is your organization ready to unlock the potential of SAP Business Technology Platform and Transform your business with SAP BTP? <Link href="https://www.erpvits.com/contact/" className="text-primary hover:text-primary-dark font-medium underline">Get in touch with ERPVITS</Link>
                </p>
            </div>
