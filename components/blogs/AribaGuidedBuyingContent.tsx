...
export default function AribaGuidedBuyingContent() {
    return (
        <div className="prose prose-lg prose-slate max-w-none 
                ...
                <table className="min-w-full border-collapse border border-slate-200">
                    <thead>
                        <tr className="bg-slate-100">
                            <th className="border border-slate-200 px-4 py-2 text-left">Catalog Type</th>
                            <th className="border border-slate-200 px-4 py-2 text-left">Features</th>
                            <th className="border border-slate-200 px-4 py-2 text-left">Best For</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td className="border border-slate-200 px-4 py-2 font-bold text-slate-900">Hosted Catalogs</td>
                            <td className="border border-slate-200 px-4 py-2 text-slate-600">Internal maintenance, custom fields, full control</td>
                            <td className="border border-slate-200 px-4 py-2 text-slate-600">Preferred suppliers, contracted items</td>
                        </tr>
                        <tr>
                            <td className="border border-slate-200 px-4 py-2 font-bold text-slate-900">Punch-Out Catalogs</td>
                            <td className="border border-slate-200 px-4 py-2 text-slate-600">Direct supplier connection, real-time pricing</td>
                            <td className="border border-slate-200 px-4 py-2 text-slate-600">Large catalogs, dynamic pricing</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <p>
                Ariba Guided Buying is a big step forward in procurement tech - merging user-friendly consumer e-commerce with business controls necessary for enterprise purchasing. Following this guide ensures satisfying workplaces and quantifiable business benefits.
            </p>

            <div className="mt-12 mb-8 bg-orange-600 text-white p-8 rounded-2xl shadow-xl">
                <h3 className="text-2xl font-bold mb-4 text-white uppercase tracking-wider">Start Your Ariba Guided Buying Journey with ERPVITS</h3>
                <p className="text-orange-50 mb-6 font-medium">
                    At ERPVITS, we specialize in implementing and optimizing SAP Ariba Solutions for organizations seeking to transform their procurement operations.
                </p>
