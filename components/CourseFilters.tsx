                ...
                <div className="bg-white p-1 rounded-xl shadow-sm border border-gray-200 inline-flex">
                    {['All', 'Functional', 'Technical'].map((cat) => (
                        <button
                            ...
                            className={cn(
                                "px-6 py-2.5 rounded-lg text-sm font-medium transition-all cursor-pointer",
                                filter === cat
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between mb-6">
                                <div className="flex items-center text-sm text-gray-600 bg-orange-50 px-3 py-1.5 rounded-full border border-orange-100">
                                    <Clock size={16} width={16} height={16} className="mr-2 text-[#ff7a3d] shrink-0" />
                            ...
                            >
                                Learn More <ArrowRight size={16} width={16} height={16} className="ml-2 shrink-0" />
                            </Link>
                        </motion.div>
                    ))}
                </AnimatePresence>
