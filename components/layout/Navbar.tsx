    ...
    return (
        <>
            ...
            <header className="sticky top-0 z-40 bg-white font-sans shadow-md">
                {/* Top Info Bar */}
                <div className="bg-slate-900 text-white text-xs py-2.5 px-4 hidden lg:block">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between h-20 items-center">
                            ...
                            <div className="hidden lg:flex space-x-1 items-center">
                                <Link href="/" className="px-3 py-2 text-slate-900 hover:text-orange-600 font-bold transition-colors rounded-lg hover:bg-orange-50 text-sm xl:text-base">
                                    Home
                                </Link>

                                <Link href="/about" className="px-3 py-2 text-slate-900 hover:text-orange-600 font-bold transition-colors rounded-lg hover:bg-orange-50 text-sm xl:text-base">
                                    About Us
                                </Link>

                                {/* Functional Dropdown */}
                                <div className="relative group">
                                    <button className="px-3 py-2 text-slate-900 group-hover:text-orange-600 font-bold inline-flex items-center transition-colors rounded-lg hover:bg-orange-50 focus:outline-none text-sm xl:text-base">
                                ...
                                {/* Blogs Dropdown */}
                                <Link href="/blog" className="px-3 py-2 text-slate-900 hover:text-orange-600 font-bold transition-colors rounded-lg hover:bg-orange-50 text-sm xl:text-base">
                                    Blogs
                                </Link>

                                <Link href="/contact" className="px-3 py-2 text-slate-900 hover:text-orange-600 font-bold transition-colors rounded-lg hover:bg-orange-50 text-sm xl:text-base">
                                    Contact
                                </Link>
                            ...
                            <div className="lg:hidden flex items-center">
                                <button onClick={() => setIsOpen(!isOpen)} className="p-2 rounded-md text-slate-900 hover:text-orange-600 hover:bg-orange-50 focus:outline-none transition-colors">
                ...
                <div className={cn("lg:hidden bg-white border-t border-gray-100 fixed inset-x-0 bottom-0 top-[6rem] z-40 transition-transform duration-300 ease-in-out transform overflow-y-auto", isOpen ? "translate-x-0" : "translate-x-full")}>
                    <div className="p-4 space-y-2 pb-20">
                        <Link href="/" className="block px-4 py-3 rounded-xl text-base font-semibold text-slate-900 hover:text-orange-600 hover:bg-orange-50" onClick={() => setIsOpen(false)}>Home</Link>
                        <Link href="/about" className="block px-4 py-3 rounded-xl text-base font-semibold text-slate-900 hover:text-orange-600 hover:bg-orange-50" onClick={() => setIsOpen(false)}>About Us</Link>

                        <div>
                            <button onClick={() => toggleDropdown('func')} className="w-full flex justify-between items-center px-4 py-3 rounded-xl text-base font-semibold text-slate-900 hover:text-orange-600 hover:bg-orange-50">
                            ...
                            <div className={cn("pl-4 space-y-1 overflow-hidden transition-all duration-300", activeDropdown === 'func' ? "max-h-[500px]" : "max-h-0")}>
                                {functionalCourses.map(course => (
                                    <Link key={course.id} href={`/courses/${course.id}`} className="block px-4 py-2 rounded-lg text-sm text-slate-700 hover:text-orange-600 hover:bg-orange-50" onClick={() => setIsOpen(false)}>
                                        {course.title}
                                    </Link>
                                ))}
                            </div>
                        ...
                        <div>
                            <button onClick={() => toggleDropdown('tech')} className="w-full flex justify-between items-center px-4 py-3 rounded-xl text-base font-semibold text-slate-900 hover:text-orange-600 hover:bg-orange-50">
                        ...
                        <Link href="/blog" className="block px-4 py-3 rounded-xl text-base font-semibold text-slate-900 hover:text-orange-600 hover:bg-orange-50" onClick={() => setIsOpen(false)}>Blogs</Link>

                        <Link href="/contact" className="block px-4 py-3 rounded-xl text-base font-semibold text-slate-900 hover:text-orange-600 hover:bg-orange-50" onClick={() => setIsOpen(false)}>Contact</Link>
