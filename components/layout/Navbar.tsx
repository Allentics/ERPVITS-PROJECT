        ...
        <header className="sticky top-0 z-40 bg-white font-sans shadow-md">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-20 items-center">
                        ...
                        <div className="hidden lg:flex space-x-1 items-center">
                            ...
                            <Link href="/contact" className="ml-4 bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-md font-extrabold transition-all shadow-lg hover:shadow-orange-500/30 transform hover:-translate-y-0.5 text-sm xl:text-base whitespace-nowrap uppercase tracking-wide">
                                Book Free Demo
                            </Link>
                        </div>
            ...
            <div className={cn("lg:hidden bg-white border-t border-gray-100 fixed inset-x-0 bottom-0 top-[6rem] z-40 transition-transform duration-300 ease-in-out transform overflow-y-auto", isOpen ? "translate-x-0" : "translate-x-full")}>
                <div className="p-4 space-y-2 pb-20">
                    ...
                    <div className="pt-4">
                        <Link href="/contact" className="block w-full text-center bg-orange-500 text-white px-5 py-4 rounded-xl font-bold shadow-lg" onClick={() => setIsOpen(false)}>
                            Book Free Demo
                        </Link>
                    </div>
                </div>
