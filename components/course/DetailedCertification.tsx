            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-6">
                        ...
                        {/* Why Matters Card - Faint Orange Theme */}
                        <div className="bg-orange-50 border border-orange-200 rounded-xl p-5 text-slate-900 mt-2">
                            <div className="flex items-center gap-3 mb-4 border-b border-orange-200 pb-3">
                                <Trophy className="w-5 h-5 text-orange-500" />
                                <h3 className="font-bold text-base text-slate-900">{renderRichText(whyMattersTitle || "Why SAP Certification Matters")}</h3>
                            </div>
                                ...
                                {benefitsToDisplay.map((benefit, idx) => (
                                    <li key={idx} className="flex gap-2 items-start">
                                        ...
                                        <span className="text-[13px]">
                                            <strong className="text-slate-900 font-bold block">{renderRichText(benefit.title)}</strong>
                                            <span className="text-slate-600 block leading-relaxed text-[11px]">{renderRichText(benefit.desc)}</span>
                                        </span>
                                    </li>
                                ))}
                            </ul>
