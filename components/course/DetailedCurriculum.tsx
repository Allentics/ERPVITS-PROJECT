...
export default function DetailedCurriculum({ modules }: DetailedCurriculumProps) {
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            <div className="text-center mb-12">
                ...
                <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-4 max-w-3xl mx-auto leading-tight">
                    SAP Ariba Course Curriculum – From Basics to Advanced Projects
                </h2>
                <p className="text-gray-600 text-lg">
                    7 comprehensive modules covering every aspect of SAP Ariba with extensive hands-on labs
                </p>
            </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-10">
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-3">
                                            {module.learning_points.map((point, j) => (
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-3">
                                            {module.hands_on.map((activity, k) => (
