...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const local = courses.find(c => c.id === 'ariba' || c.id === 'sap-ariba');
    ...
    return {
        ...
        alternates: {
            canonical: 'https://www.erpvits.com/sap-ariba-training/',
        },
    };
}

export default function Page() {
    return <CoursePage params={Promise.resolve({ slug: 'ariba' })} />;
}
