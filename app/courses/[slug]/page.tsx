...
const FAQ = dynamic(() => import('@/components/course/FAQ'));
const ComparisonTable = dynamic(() => import('@/components/home/ComparisonTable'));
const SectionRenderer = dynamic(() => import('@/components/course/SectionRenderer'));
const DetailedFeatures = dynamic(() => import('@/components/course/SectionRenderer').then(mod => mod.DetailedFeatures));
const DetailedDemoBooking = dynamic(() => import('@/components/course/DetailedDemoBooking'));
const DetailedFAQ = dynamic(() => import('@/components/course/DetailedFAQ'));
const DetailedPrerequisites = dynamic(() => import('@/components/course/DetailedPrerequisites'));
const DetailedTargetAudience = dynamic(() => import('@/components/course/DetailedTargetAudience'));
const CourseEnrollmentCTA = dynamic(() => import('@/components/course/CourseEnrollmentCTA'));
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        ...
                        <div className="lg:col-span-7 text-left">
                            {/* Heading */}
                            <h1 className="text-2xl lg:text-3xl font-extrabold mb-8 leading-tight tracking-tight text-slate-900 course-h1-inline">
                                        ...
                                        <div className="text-left">
                                            ...
                                            <div className="flex flex-col gap-1">
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    <a href="#reviews" className="text-[#ff4500] hover:text-[#ff4500] hover:underline transition-colors font-medium text-[10px]">
