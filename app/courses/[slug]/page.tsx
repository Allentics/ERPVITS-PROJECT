...
export default async function CoursePage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const mappedCourse = {
        ...localCourse,
        ...course,
        heroHeading: (isFieldglass || isMM || isFICO || isTRM || isSD || isC4C || isABAP || isCPI || isPPDS || isTM || isEWM || isIBP || isMDG || isC4CFunc || isABAPHana || isPython) ? localCourse?.heroHeading : (course?.hero_heading || localCourse?.heroHeading),
        heroSubheading: (isFieldglass || isMM || isFICO || isTRM || isSD || isC4C || isABAP || isCPI || isPPDS || isTM || isEWM || isIBP || isMDG || isC4CFunc || isABAPHana || isPython) ? localCourse?.heroSubheading : (course?.hero_subheading || localCourse?.heroSubheading),
        heroImage: (isFICO || isFieldglass || isMM || isTRM || isSD || isC4C || isABAP || isCPI || isPPDS || isTM || isEWM || isIBP || isMDG || isC4CFunc || isABAPHana || isPython) ? undefined : (localCourse?.heroImage || course?.hero_image),
        ...
        sections: (isFieldglass || isMM || isFICO || isTRM || isSD || isC4C || isABAP || isCPI || isPPDS || isTM || isEWM || isIBP || isMDG || isC4CFunc || isABAPHana || isPython) ? localCourse?.sections : ((course?.sections && course.sections.length > 0) ? course.sections : localCourse?.sections),
