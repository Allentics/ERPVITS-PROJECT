...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const local = courses.find(c => c.id === 'fico'); // Map sap-fico to fico ID
    ...
    return {
        ...
        alternates: {
            canonical: 'https://www.erpvits.com/sap-fico-course/',
        },
    };
}

export default function Page() {
    return <CoursePage params={Promise.resolve({ slug: 'sap-fico' })} />;
}
