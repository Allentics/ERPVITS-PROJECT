...
export const ppdsContent = {
    ...
    sections: [
        ...
        },
        {
            type: 'whats_included',
            stats: [
                { value: "35-40", label: "Hours of Live Training" },
                { value: "40+", label: "Hands-On Lab Exercises" },
                { value: "24/7", label: "SAP PPDS Lab Access" }
            ],
        ...
        },
        {
            ...
            items: [
                { name: "Amit Kumar", role: "SAP PPDS Consultant at Siemens", quote: "Outstanding PPDS training with real production planning project exposure. I landed a planning role at Siemens within 8 weeks managing PPDS implementations. The hands-on labs and expert instructors made all the difference." },
                { name: "Priya Singh", role: "Senior Planning Manager", quote: "The weekend flexibility allowed me to upskill in production planning while working. My employer promoted me to Senior Planning Manager recognizing my new PPDS skills. This course accelerated my career by 4 years." },
                { name: "Vikram Patel", role: "PPDS Consultant", quote: "Best decision for my supply chain career. The capstone projects mirrored real planning scenarios. I walked in confident in scheduling and forecasting. The certification support was exceptional." },
                { name: "Ananya Desai", role: "Certified PPDS Professional", quote: "Superb technical training and certification prep. I passed the SAP PPDS exam on first attempt. The mock exams and planning case studies were spot-on. Now leading PPDS implementations." },
                { name: "Sanjay Verma", role: "Supply Chain Architect", quote: "The instructor's insights on capacity planning and optimization were invaluable. Learned not just PPDS but supply chain thinking. The alumni network brought several consulting opportunities." },
                { name: "Sneha Reddy", role: "PPDS Analyst at Infosys", quote: "From junior planner to PPDS specialist in 5 months! Patient instructors providing detailed guidance. Lifetime recording access is invaluable for reference." }
            ]
        },
        {
            ...
            features: [
                ...
                { icon: "Users", text: "Personal PPDS learning path consultation" },
                { icon: "ShieldCheck", text: "Priority support and production planning mentoring" },
        ...
        },
        {
            type: 'detailed_faq',
            items: [
                { q: "What is SAP PPDS and how does ERPVITS help me learn it?", a: "SAP PPDS is the production planning and detailed scheduling module in SAP S/4HANA for optimizing manufacturing processes. ERPVITS provides comprehensive training covering demand forecasting, master scheduling, and capacity planning with real-world scenarios." },
