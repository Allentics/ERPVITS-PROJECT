...
export const abapHanaContent = {
    ...
    "features": [
        ...
        "Complete code review and architecture feedback sessions"
    ],
    "sections": [
        {
        ...
        },
        {
            ...
            "stats": [
                ...
                {
                    "color": "orange",
                    "label": "Hands-On Coding Labs",
                    "value": "100+"
                },
                {
                    "color": "orange",
                    "label": "SAP HANA Lab Access",
                    "value": "24/7"
                }
            ],
        ...
        },
        {
            ...
            "features": [
                ...
                {
                    "icon": "Users",
                    "text": "1-on-1 coding mentorship sessions"
                },
                {
                    "icon": "ShieldCheck",
                    "text": "Priority code review from certified developers"
                },
                {
                    "icon": "CheckCircle2",
                    "text": "Networking with cohort of developers"
                },
                {
                    "icon": "Target",
                    "text": "Guaranteed access to latest HANA and S/4HANA"
                },
                {
                    "icon": "ShieldCheck",
                    "text": "Exclusive access to code optimization workshops"
                },
                {
                    "icon": "Award",
                    "text": "Career-accelerated placement guarantee"
                }
            ],
        ...
        },
        {
            ...
            "items": [
                {
                    "name": "Michael Chen",
                    "role": "SAP ABAP Developer at Google",
                    "text": "The hands-on labs were incredible. I went from knowing zero ABAP to building full Fiori apps in 3 months. The instructor's deep industry knowledge made all the difference.",
                ...
                },
                {
                    ...
                    "text": "The certification support was spot on. I passed my C_TAW12_750 exam with 92% score on the first attempt thanks to their practice tests and study guides.",
                ...
                },
                {
                    ...
                    "text": "I was skeptical about online training but the live interactive sessions and code reviews were better than any classroom training I've attended. Highly recommended!",
                ...
                },
                {
                    ...
                    "text": "The career support team helped me rewrite my resume and prepared me for technical interviews. I landed my dream job at Microsoft within 6 weeks of completing the course.",
                    ...
                    "author": "Shweta Kaushik"
                },
                {
                    "name": "Bharat Bhardwaj",
                    "role": "Senior Developer at Infosys",
                    "text": "Coming from a Java background, this course bridged the gap perfectly. The OOP ABAP module is excellent and helped me transition smoothly to enterprise development.",
                ...
                },
                {
                    ...
                    "text": "The real-world project scenarios gave me the confidence to handle actual client requirements. The depth of HANA optimization topics is unmatched.",
        ...
        },
        {
            ...
            "benefits": [
                {
                    "desc": "",
                    "title": "Live interaction with SAP Certified Instructor"
                },
                {
                    "desc": "",
                    "title": "Overview of ABAP on HANA Architecture"
                },
                {
                    "desc": "",
                    "title": "Walkthrough of Hands-On Lab Environment"
                },
                {
                    "desc": "",
                    "title": "Discussion on Career Path and Job Market"
                },
                {
                    "desc": "",
                    "title": "Q&A session to clear your doubts"
                }
            ],
    ...
    "faqs": [
        ...
        {
            "answer": "ERPVITS SAP ABAP training fees are competitive with all-inclusive pricing covering instruction, labs, materials, and placement support. Contact us for current pricing and early-bird discounts.",
            "question": "What are SAP ABAP training fees at ERPVITS?"
        },
        {
            "answer": "Join our structured ABAP training, complete coding projects, obtain certifications, build a strong portfolio, and leverage our placement support to secure ABAP developer roles.",
