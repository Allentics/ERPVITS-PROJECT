    ...
    "sections": [
        {
            ...
            "items": [
                ...
                },
                {
                    ...
                    "description": "Once the SAP C4C course is over, you'll continue receiving mentorship and advice to address project challenges, prepare for <a href=\"https://www.erpvits.com/blog/sap-c4c-certification\" target=\"_blank\" rel=\"noopener noreferrer\">SAP C4C certification</a> and advance within the SAP ecosystem."
                }
            ],
        ...
        },
        {
            ...
            "features": [
                ...
                },
                {
                    ...
                    "description": "Work on Fortune 500-inspired case studies covering sales pipeline and service ticket workflows."
                },
                {
                    "title": "Hands-On Lab Environment",
                    "description": "Get full-time access to SAP C4C cloud systems to practice account management and CRM analytics."
                },
                {
                    "title": "Certification Exam Prep",
                    "description": "Prepare for SAP Certified Application Associate – SAP C4C (C_C4C14_2404) with study guides and practice exams."
                },
                {
                    "title": "Resume & Interview Coaching",
                    "description": "Personalized resume optimization and mock consulting interviews focusing on CRM operations."
                },
                {
        ...
        },
        {
            ...
            "items": [
                {
                    "stage": "Start (1-3)",
                    "title": "Jr. C4C Consultant",
                    "description": "Support sales/service process configuration, user management, basic reporting."
                },
                {
                    "stage": "Mid-Level (4-6)",
                    "title": "Sr. C4C Consultant / Architect",
                    "description": "Lead workshops, solution design, integration planning, complex workflows."
                },
                {
                    "stage": "Senior (7-10+)",
                    "title": "Principal Consultant / Manager",
                    "description": "CX strategy, multi-cloud architecture, program management."
                }
            ],
            "stats": [
                {
                    ...
                    "stats": [
                        {
                            ...
                            "value": "350%+",
                            "subLabel": "For C4C Consultants"
                        },
                        {
                            "color": "green",
                            "label": "Demand for Cloud CRM",
                            "value": "High",
                            "subLabel": "Enterprise Adoption"
                        },
                        {
                            "color": "purple",
                            "label": "Salaries for Certified",
                            "value": "Premium",
                            "subLabel": "15-30% Higher Pay"
                        },
                        {
                            "color": "orange",
                            "label": "Remote Opportunities",
                            "value": "Global",
                            "subLabel": "Mid to Senior Levels"
                        }
                    ],
        ...
        },
        {
            ...
            "features": [
                ...
                {
                    "icon": "CheckCircle2",
                    "text": "Networking with cohort members targeting CRM roles"
                },
                {
                    "icon": "Users",
                ...
                {
                    "icon": "Cloud",
                    "text": "Access to latest SAP C4C and cloud CRM updates"
                },
                {
                    "icon": "BarChart",
                    "text": "Exclusive access to customer engagement strategy workshops"
                }
            ],
        ...
        },
        {
            ...
            "benefits": [
                ...
                {
                    "desc": "Ask questions about course, certification, and career",
                    "title": "Instructor Q&A"
                },
                {
                    "desc": "Exclusive discount for demo attendees (10-15% off)",
