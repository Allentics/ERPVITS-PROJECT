export const ficoContent = {
    ...
    sections: [
        {
            type: 'features',
            title: "Why Choose Our SAP FICO Training?",
            items: [
                "SAP Certified Trainers with 12+ Years Experience",
                "100% Hands-On Scenarios in SAP S/4HANA System",
        ...
        },
        {
            ...
            items: [
                ...
                { q: "Does ERPVITS provide SAP FICO Training with Placement Support?", a: "Absolutely! ERPVITS provides SAP FICO training along with placement support. We allow training by building profiles, guiding interviews, and working with recruiters." },
