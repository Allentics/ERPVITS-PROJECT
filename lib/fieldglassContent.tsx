...
export const fieldglassContent = {
    ...
    "sections": [
        ...
        },
        {
            ...
            "benefits": [
                {
                    "desc": "SAP Fieldglass certifications are widely acknowledged by employers, clients, and VMS recruitment agencies worldwide.",
                    "icon": "Globe",
                    "title": "Globally Recognized Credentials"
                },
                {
                    "desc": "Certified Fieldglass professionals earn between 20-35% more than their non-certified peers.",
                    "icon": "TrendingUp",
                    "title": "Increased Earning Potential"
                },
                {
                    "desc": "Clients and employers will regard you more highly for having met the industry’s demanding VMS standards.",
                    "icon": "Award",
                    "title": "Enhanced Professional Reputation"
                },
                {
                    "desc": "FA Certified Fieldglass professionals also enjoy less competition for VMS job applications and contingent workforce consulting proposals.",
                    "icon": "CheckCircle2",
                    "title": "Market Differentiation"
                },
                {
                    "desc": "Certification motivates you to master the evolving VMS platform.",
                    "icon": "BookOpen",
            ...
            "supportFeatures": [
                {
                    ...
                    "subtitle": "Comprehensive guides that match SAP exam blueprints"
                },
                {
                    "title": "Mock Exams",
                    "subtitle": "Practice exams to simulate time constraints and real exam scenarios for Fieldglass"
                },
                {
                    "title": "Exam Techniques",
                    "subtitle": "Time management tips, question-reading strategies, and pitfalls to avoid"
                },
                {
                    "title": "Exam Scheduling Assistance",
                    "subtitle": "Help with exam enrollment and scheduling coordination"
                },
                {
                    "title": "Retake Guidance",
                    "subtitle": "If you don’t pass on your first attempt, we will provide tailored Fieldglass support regarding the exam's content and guide you on how to retake it."
                }
            ]
        },
        {
            ...
            "customData": {
                ...
                "hiringTrends": {
                    "stats": [
                        ...
                        {
                            "color": "green",
                            "label": "S/4HANA Integration Expertise",
                            "value": "High Demand"
                        }
                    ],
        ...
        },
        {
            ...
            "features": [
                ...
                {
                    "icon": "Users",
                    "text": "Personal VMS learning path consultation"
                },
                {
                    "icon": "ShieldCheck",
                    "text": "Priority support and mentoring on Fieldglass"
                },
                {
                    "icon": "CheckCircle2",
                    "text": "Networking with cohort members in contingent workforce domain"
                },
                {
                    "icon": "Users",
        ...
        },
        {
            ...
            "benefits": [
                {
                    "desc": "Observe real SAP Fieldglass training and instructor methodology",
                ...
                {
                    "desc": "Ask questions about SAP Fieldglass course, certification, and career",
