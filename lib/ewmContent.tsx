...
export const ewmContent = {
    ...
    "metaDescription": "Advance your logistics career with SAP EWM course covering warehouse automation, order fulfillment & S/4HANA integration. Get SAP EWN certification support.",
    "features": [
    ...
    "sections": [
            ...
            "items": [
                {
                    ...
                    "description": "SAP EWM training sessions are delivered by SAP EWM certified consultants who have delivered large-scale EWM rollouts for top companies. They bring live project scenarios, real SAP EWM configuration patterns and their best practices into every session, not just textbook concepts. You learn how decisions are actually made during an SAP EWM implementation."
                },
                {
                    "icon": "Laptop",
                    "title": "100% Hands-On Learning ",
                    "description": "At ERPVITS, every session includes guided lab activities within a live SAP EWM system. This will allow you to learn how to build structures for warehouse numbers, storage sections and storage bins. By the end of course you will execute the entire SAP EWM physical inventory process including documents of the inventory and difference postings, manage essential SAP EWM tables for data interrogation and troubleshooting and configure SAP EWM yard management."
                },
                {
                    "icon": "MessageCircle",
                    "title": "Interactive Q&A Sessions",
                    "description": "Every week, we host interactive Q&A sessions to clarify advanced SAP EWM topics include; QM integration, MFS, slotting, labor management, TM integration, Embedded EWM vs Decentralized EWM. You can bring configuration challenges, ongoing project issues and interview related questions. For clearer understanding, instructors give tailored explanations and demonstrate on the live system."
                },
                {
                    "icon": "Clock",
                    "title": "Flexible Batch Timings",
                    "description": "We provide morning and evening weekday batches, as well as dedicated Saturday and Sunday weekend batches and all these sessions are aimed at providing flexible schedule for working professionals across the globe. Your SAP EWM learning is at your own pace, without compromise."
                },
                {
                    "icon": "Users",
                    "title": "Small Batch Sizes",
                    "description": "We limit each SAP EWM training batch to 8-10 participants. In a group of 8-10, instructor understands your professional history, the industry you come from, the gaps in your EWM knowledge and the target role you are aiming for. The small batch structure means your progress is closely monitored, your questions are given top priority, and your training is truly customized to your destination."
                },
                {
                    "icon": "TrendingUp",
                ...
                },
                {
                    ...
                    "description": "Becoming part of ERPVITS links you to a vast and expanding international community of SAP EWM professionals employed by top consulting firms and businesses. Networking members share real-time SAP EWM configuration knowledge, provide updates on new features of S/4HANA EWM and offer job postings for SAP EWM consultant jobs. You will continue to be active in EWM professional community after you finish your training cohort."
                },
                {
                    "icon": "Headphones",
                    "title": "Ongoing support Post-Training",
                    "description": "Your investment in this SAP EWM course is safeguarded for six months following the last session of the course. This means, after six months of the course, you will have unlimited access to instructor support for any questions you may have as you engage in actual project work. You will get support for SAP EWM configuration challenges; questions regarding SAP EWM tables, questions on the SAP EWM physical inventory process or if you simply need assistance in executing or structuring your major EWM project. We value continued support through the complex phases of your EWM career."
                }
            ],
            "title": "Learn SAP EWM from Certified Experts – 100% Hands-On, Job-Oriented Training",
            "subtitle": "We offer implementation-centered SAP EWM training, which includes live SAP EWM system training, actual warehouse business processes, a well-organized training lab with exercises, coaching, and a career mentorship program — all using a live SAP EWM software from the first class. Our course design intentionally avoids the use of SAP EWM training material PDF and SAP EWM tutorial videos. Instead, we provide instruction based on a real EWM project so that our trainees can learn from the best – SAP trainers with at least 12 years of experience in implementing SAP EWM in complicated multi-site global projects.",
            "textAlign": "left"
        },
        {
            ...
            "layout": "left",
            "imageSrc": "https://xwcpxwjxqllfwferproi.supabase.co/storage/v1/object/public/media-library/general/sap-ewm-training-1771992960324.png",
        ...
        },
        {
            ...
            "title": "What's Included in the SAP EWM Training",
            "features": [
                {
        ...
        },
        {
            ...
            "stats": [
                {
                    "icon": "Clock",
                    "label": "Average Time to First Role",
                    "value": "2-3 Months"
                },
                {
                    "icon": "Briefcase",
                    "label": "Career support Provided",
                    "value": "100%"
                },
                {
                    "icon": "Headphones",
        ...
        },
        {
            ...
            "features": [
                ...
                {
                    "icon": "Users",
                    "text": "Personal learning path consultation with trainers"
                },
                {
                    "icon": "ShieldCheck",
                    "text": "Priority support and mentoring throughout course"
                },
                {
                    "icon": "CheckCircle2",
                    "text": "Networking with cohort members aspiring for warehouse roles"
                },
                {
                    "icon": "ShieldCheck",
                    "text": "Guaranteed access to current curriculum and certified trainers"
                },
                {
                    "icon": "Users",
                    "text": "Access to latest SAP EWM and S/4HANA updates"
                }
            ],
            ...
            "items": [
                {
                    ...
                    "author": "Vivaan Chaturvedi"
                },
                {
                    "name": "Myra Suryanarayan",
                    "role": "Warehouse Operations Manager",
                    "text": "The weekend flexibility allowed me to learn while managing a warehouse. My employer was so impressed with my EWM expertise that they promoted me to Warehouse Operations Manager. This course accelerated my career by 5 years.",
                    ...
                    "author": "Myra Suryanarayan"
                },
                {
                    "name": "Kaya Prabhudesai",
                    "role": "Senior SAP EWM Consultant",
                    "text": "Best investment in my career. The capstone projects were exactly like real warehouse implementations—managing inbound/outbound, configuring RF devices, optimizing picking strategies. I walked into my first consulting role feeling confident, not intimidated. The certification support was exceptional.",
                    ...
                    "author": "Kaya Prabhudesai"
                },
                {
                    "name": "Samyuktha Poluri",
                    "role": "Certified SAP EWM Professional",
                    "text": "Superb certification preparation. I passed the C_S4EWM_2023 exam on my first attempt with 82%. The mock exams and warehouse scenario practice were spot-on and covered every topic thoroughly. Highly recommended!",
                ...
                },
                {
                    ...
                    "text": "From zero SAP EWM knowledge to landing my dream role in warehouse management consulting in 4 months! The instructors are patient, knowledgeable, and truly care about student success. The lifetime recording access is a huge bonus for refreshing concepts during projects.",
        ...
        },
        {
            ...
            "items": [
                ...
                {
                    "q": "What makes SAP EWM a lucrative career choice?",
                    ...
                    "question": "What makes SAP EWM a lucrative career choice?"
                },
                {
