        ...
        "faqPage": {
            ...
            "mainEntity": [
                ...
                },
                {
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Major adapters include SOAP, OData, HTTP, SFTP, IDoc, SuccessFactors, Ariba, AS2/AS4, JMS, and RFC, with hands-on practice."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Do I need SAP PI/PO experience?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "No, CPI training covers fundamentals suitable for beginners and those without PI/PO experience."
                    }
                },
                {
                    "@type": "Question",
                    "name": "What are the career options after SAP CPI training?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Roles include SAP CPI Developer, Integration Consultant, Cloud Architect, and Middleware Specialist."
                    }
                }
            ]
        }
